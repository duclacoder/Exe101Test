    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-blue-50 pt-20">
      <div className="container mx-auto px-6 py-16">
        ...
        <p className="text-xl text-slate-600 text-center mb-16 max-w-3xl mx-auto">
          Đội ngũ hỗ trợ của ChemXLab luôn sẵn sàng giải đáp mọi thắc mắc của bạn
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto mb-28">
          ...
          <div>
            ...
            <div className="space-y-6">
              {[
                { icon: <Mail className="w-7 h-7 text-white" />, text: "support@chemxlab.com", color: "from-blue-500 to-blue-700" },
                { icon: <Phone className="w-7 h-7 text-white" />, text: "+84 123 456 789", color: "from-green-500 to-green-700" },
                { icon: <MapPin className="w-7 h-7 text-white" />, text: "Khu Công nghệ cao, TP. Thủ Đức, TP.HCM", color: "from-red-500 to-red-700" },
                { icon: <MessageCircle className="w-7 h-7 text-white" />, text: "Chat trực tuyến (8:00 - 17:00)", color: "from-purple-500 to-purple-700" }
              ].map((item, i) => (
                <div key={i} className={`flex items-center gap-5 bg-gradient-to-r ${item.color} p-6 rounded-2xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all`}>
        ...
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-slate-900 mb-12 text-center">Câu hỏi thường gặp</h2>
          <div className="space-y-6">
            {[
              {
              ...
              <div key={i} className="bg-white rounded-2xl p-8 shadow-xl border-2 border-blue-100 hover:border-blue-400 hover:shadow-2xl transition-all">
